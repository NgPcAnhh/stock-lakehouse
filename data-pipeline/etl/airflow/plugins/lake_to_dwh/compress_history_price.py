"""
Compression logic for history_price data from CSV to Parquet.
...
def compress_history_price(
    bucket: str,
    source_folder: str = "history_price",
    target_folder: str = "parquet",
    conn_id: str = "minio_finance",
    compression: str = "snappy"
) -> Dict[str, Any]:
    """
    Compress all history_price partitions from CSV to Parquet.
    
    Args:
        bucket: MinIO bucket name
        source_folder: Source folder name (default: "history_price")
    ...
    """
    print("=" * 70)
    print("📈 COMPRESSING HISTORY_PRICE DATA TO PARQUET")
    print("=" * 70)
    ...
    try:
        ...
        # Summary
        print("\n" + "=" * 70)
        print("📊 HISTORY_PRICE COMPRESSION SUMMARY")
        print("=" * 70)
        ...
        error_msg = str(e)
        print(f"❌ Fatal error in history_price compression: {error_msg}")
