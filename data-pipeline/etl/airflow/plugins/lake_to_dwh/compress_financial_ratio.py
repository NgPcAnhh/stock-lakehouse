"""
Compression logic for financial_ratio data from CSV to Parquet.
...
def compress_financial_ratio(
    bucket: str,
    source_folder: str = "financial_ratio",
    target_folder: str = "parquet",
    conn_id: str = "minio_finance",
    compression: str = "snappy"
) -> Dict[str, Any]:
    """
    Compress all financial_ratio partitions from CSV to Parquet.
    
    Args:
        bucket: MinIO bucket name
        source_folder: Source folder name (default: "financial_ratio")
    ...
    """
    print("=" * 70)
    print("💹 COMPRESSING FINANCIAL_RATIO DATA TO PARQUET")
    print("=" * 70)
    ...
    try:
        ...
        # Summary
        print("\n" + "=" * 70)
        print("📊 FINANCIAL_RATIO COMPRESSION SUMMARY")
        print("=" * 70)
        ...
        error_msg = str(e)
        print(f"❌ Fatal error in financial_ratio compression: {error_msg}")
